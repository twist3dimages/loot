...
<paper-material id="wrapper" elevation="1">
    ...
    <paper-tooltip for="activeTick">[[_localise('Active Plugin')]]</paper-tooltip>
    <div id="title">
        <slot name="name"></slot>
    ...
    <paper-tooltip for="isMaster">[[_localise('Master File')]]</paper-tooltip>
    <iron-icon id="isLightMaster" icon="image:flare"></iron-icon>
    <paper-tooltip for="isLightMaster">[[_localise('Light Master File')]]</paper-tooltip>
    <iron-icon id="isEmpty" icon="visibility-off"></iron-icon>
    <paper-tooltip for="isEmpty">[[_localise('Empty Plugin')]]</paper-tooltip>
    <iron-icon id="loadsArchive" icon="attachment"></iron-icon>
    <paper-tooltip for="loadsArchive">[[_localise('Loads Archive')]]</paper-tooltip>
    <iron-icon id="isClean" icon="loot-custom-icons:droplet"></iron-icon>
    <paper-tooltip id="isCleanTooltip" for="isClean">[[_localise('Is Clean')]]</paper-tooltip>
    <iron-icon id="hasUserEdits" icon="account-circle"></iron-icon>
    <paper-tooltip for="hasUserEdits">[[_localise('Has User Metadata')]]</paper-tooltip>
